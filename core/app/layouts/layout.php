...
<html>
  <head>
    <meta charset="UTF-8">
    <title>CLINICA AREQUIPA | Dashboard</title>
  ...
  <body class="<?php if(isset($_SESSION["user_id"])):?>  skin-blue-light sidebar-mini <?php else:?>login-page<?php endif; ?>" >
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg">CA<b>ADMIN</b></span>
        </a>
    ...
    <?php endif;?>
      ...
      <div class="content-wrapper">
        ...
        <strong>Copyright &copy; 2020 <a href="http://evilnapsis.com/" target="_blank">CLINICA AREQUIPA S.A.</a></strong>
      </footer>
      <?php else:?>

<div class="login-box">
      <div class="login-logo">
        <center><h4><img src="archivos/logo.png"></h4></center>
      </div><!-- /.login-logo -->
